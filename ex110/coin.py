...
def overview(price = 0, rateincrese = 0, ratedecrease = 0):
    print('-' *40)
    ...
    print(f'{rateincrese}% increase: \t\t{increase(price)}')
    print(f'{ratedecrease}% decrease: \t\t{decrease(price)}') # \t para tabulação
    print('-' *40)